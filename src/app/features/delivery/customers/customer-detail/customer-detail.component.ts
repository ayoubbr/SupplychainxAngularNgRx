...
@Component({
  ...
  `,
    ...
    .label { width: 150px; color: #a0a0a0; font-weight: 500; }
    .value { color: white; flex: 1; }
    
    .stats-section { margin-top: 2rem; }
    .stats-section h3 { margin-bottom: 1rem; color: #a0a0a0; font-size: 1.1rem; }
    .stat-card {
        display: inline-flex; flex-direction: column;
        background: rgba(0,0,0,0.2);
        padding: 1rem; border-radius: 8px;
        margin-right: 1rem; min-width: 150px;
    }
    .stat-label { font-size: 0.8rem; color: #a0a0a0; margin-bottom: 0.5rem; }
    .stat-value { font-size: 1.5rem; font-weight: bold; }

    .btn { padding: 0.5rem 1rem; border-radius: 6px; cursor: pointer; text-decoration: none; display: inline-block; }
    .btn-secondary { background: rgba(255, 255, 255, 0.1); color: white; }
    .btn-primary { background: #3b82f6; color: white; }

    .loading { display: flex; align-items: center; gap: 1rem; justify-content: center; }
    .spinner {
        width: 24px; height: 24px;
        border: 3px solid #ffffff; border-top-color: transparent;
